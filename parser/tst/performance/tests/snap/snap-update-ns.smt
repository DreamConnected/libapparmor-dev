...
profile snap-update-ns.smt (attach_disconnected) {
  ...
  /run/snapd/lock/smt.lock rwk,
  /run/snapd/lock/.lock rwk,

  # Allow reading stored mount namespaces,
  /run/snapd/ns/ r,
  /run/snapd/ns/smt.mnt r,
  ...
  /var/lib/snapd/mount/snap.smt.fstab r,
  /var/lib/snapd/mount/snap.smt.user-fstab r,
  ...
  /run/snapd/ns/snap.smt.fstab{,.*} rw,
  ...
  /sys/fs/cgroup/freezer/snap.smt/freezer.state rw,

  # Allow the content interface to bind fonts from the host filesystem
  mount options=(ro bind) /var/lib/snapd/hostfs/usr/share/fonts/ -> /snap/smt/*/**,
  umount /snap/smt/*/**,
